...
/* 0 */
/*!*************************************************************!*\
  !*** C:/Users/lobo/Desktop/uniapp/lobo-shop-uniapp/main.js ***!
  \*************************************************************/
...
wx.__webpack_require_UNI_MP_PLUGIN__ = __webpack_require__; //云托管初始化
wx.cloud.init(); //封装请求函数
uni.lobo = {};uni.lobo.request = /*#__PURE__*/function () {var _ref2 = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee(_ref) {var url, method, data, query, header, result, token;return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:url = _ref.url, method = _ref.method, data = _ref.data, query = _ref.query, header = _ref.header;uni.showLoading({ title: '请求数据中' });result = {}; //获取token
            token = uni.getStorageSync('token'); //判断是不是本地开发测试
            if (!(url.indexOf('127.0.0.1') !== -1)) {_context.next = 12;break;} //请求拦截
            console.log('本地请求');_context.next = 8;return new Promise(function (resolve, reject) {uni.request({ url: url, method: method, data: data, header: { token: token }, success: function success(res) {//响应拦截
                  if (res.data.code === 201) {_index.default.commit('userStore/muSetToken', '');uni.switchTab({ url: '/pages/user/user' });resolve({});} else {resolve(res.data);}console.log('本地请求成功');}, fail: function fail(err) {return console.log('本地请求失败:', url, err);}, complete: function complete() {return console.log('本地请求结束了');} });});case 8:result = _context.sent;console.log('返回响应');_context.next = 16;break;case 12:_context.next = 14;return wx.cloud.callContainer({ "config": { "env": "prod-8gmhhtejbb2f1d96" }, "path": url + (query ? '?' + uni.lobo.urlEndcode(query) : ''), "header": { "X-WX-SERVICE": "lobo-shop", "content-type": "application/json", "token": token }, data: data, "method": method });case 14:result = _context.sent; //响应拦截
            //登陆超时
            if (result.data.code === 201) {_index.default.commit('userStore/muSetToken', '');uni.showToast({ title: '请先登陆', icon: 'none', duration: 1500 });setTimeout(function () {uni.switchTab({ url: '/pages/user/user' });}, 500);}case 16:uni.hideLoading();return _context.abrupt("return", result);case 18:case "end":return _context.stop();}}}, _callee);}));return function (_x) {return _ref2.apply(this, arguments);};}(); //query参数urlEncode
uni.lobo.urlEndcode = function (query) {var params = Object.keys(query).map(function (key) {return encodeURIComponent(key) + '=' + encodeURIComponent(query[key]);}).join('&');return params;};_vue.default.use(_uviewUi.default);_vue.default.config.productionTip = false;_App.default.mpType = 'app';var app = new _vue.default(_objectSpread(_objectSpread({}, _App.default), {}, { store: _index.default }));
...
/* 9 */
/*!*************************************************************!*\
  !*** C:/Users/lobo/Desktop/uniapp/lobo-shop-uniapp/App.vue ***!
  \*************************************************************/
/*! no static exports found */
...
/* 10 */
/*!**************************************************************************************!*\
  !*** C:/Users/lobo/Desktop/uniapp/lobo-shop-uniapp/App.vue?vue&type=script&lang=js& ***!
  \**************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* 11 */
/*!*********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--12-1!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/script.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!C:/Users/lobo/Desktop/uniapp/lobo-shop-uniapp/App.vue?vue&type=script&lang=js& ***!
  \*********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* 12 */
/*!***********************************************************************************************!*\
  !*** C:/Users/lobo/Desktop/uniapp/lobo-shop-uniapp/App.vue?vue&type=style&index=0&lang=scss& ***!
  \***********************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
